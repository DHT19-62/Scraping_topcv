...
class envi_Cambridge {
    ...
    async displayName() {
        ...
        if (locale.indexOf('CN') != -1) return 'EN-VI';
        if (locale.indexOf('TW') != -1) return 'EN-VI';
    ...
    async findCambridge(word) {
        ...
        let base = 'https://dictionary.cambridge.org/vi/dictionary/english-vietnamese/direct/?q=';
